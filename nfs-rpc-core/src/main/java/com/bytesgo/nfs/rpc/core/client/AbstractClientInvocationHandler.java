...
public abstract class AbstractClientInvocationHandler implements InvocationHandler {
	...
	// per method timeout,some special method use methodName.toLowerCase to set
	// timeout,other use *
	...
	public Object invoke(Object proxy, Method method, Object[] args) throws Throwable {
		...
		Invocation invocation = new Invocation().setProcessorName(targetInstanceName).setMethodName(methodName)
				.setArgTypes(argTypes).setArgs(args);
		return client.invokeSync(invocation, timeout, codecType, protocolType);
	}
