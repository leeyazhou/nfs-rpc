package com.xyz.rpc.netty.protocol;
...
public class NettyProtocolDecoder extends FrameDecoder {
  ...
  private void callDecode(ChannelHandlerContext context, Channel channel, ChannelBuffer cumulation, SocketAddress remoteAddress)
      throws Exception {
