package com.bytesgo.nfs.rpc.common.benchmark;
...
public class SimpleProcessorBenchmarkClientRunnable implements ClientRunnable {
  ...
  private static final Logger LOGGER = LoggerFactory.getLogger(SimpleProcessorBenchmarkClientRunnable.class);
  ...
  public SimpleProcessorBenchmarkClientRunnable(ClientFactory factory, String targetIP, int targetPort, int clientNums, int rpcTimeout,
      int codecType, int requestSize, CyclicBarrier barrier, CountDownLatch latch, long startTime, long endTime) {
  ...
  private void runPB() {
    while (running) {
      com.bytesgo.nfs.rpc.common.benchmark.PB.RequestObject.Builder objectBuilder = PB.RequestObject.newBuilder();
