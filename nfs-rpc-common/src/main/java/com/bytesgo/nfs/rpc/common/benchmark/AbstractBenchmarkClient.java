...
public abstract class AbstractBenchmarkClient {
  ...
  public void run(String[] args) throws Exception {
    ...
    for (int i = 0; i < concurrents; i++) {
      ClientRunnable runnable = getClientRunnable(serverIP, serverPort, clientNums, timeout, codectype, requestSize, barrier, latch,
    ...
    System.out.println(" Requests: " + allRequest + " Success: " + (allRequestSum + ignoreRequest) * 100 / allRequest + "% ("
        + (allRequestSum + ignoreRequest) + ") Error: " + (allErrorRequestSum + ignoreErrorRequest) * 100 / allRequest + "% ("
  ...
  public abstract ClientRunnable getClientRunnable(String targetIP, int targetPort, int clientNums, int rpcTimeout, int codecType,
